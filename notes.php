...
<br>
<div class="hello">-NOTES- sorted by creation time</div>
<br>
 
<?php $idea=$_SESSION['id'];
 $res = mysqli_query($dbb, "SELECT * FROM notes where ide='$idea' order by date_created"); ?>
...
<?php while ($ro = mysqli_fetch_array($res)):?>
 ...
 <a class="button button3" href="server2.php?dl2=<?php echo $ro['title']; ?>&iid2=<?php echo $_SESSION['id']; ?>">DELETE</a>
 <a class="button button2" href="server2.php?ed2=<?php echo $ro['title']; ?>&iid3=<?php echo $_SESSION['id']; ?>&conn2=<?php echo $ro['content']; ?>">EDIT</a>
 <br>
 <br>
 <br>
<?php endwhile; ?>
